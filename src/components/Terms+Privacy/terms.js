    ...
    <>
      <div id="tp-wrapper">
        ...
        <section id="tp-section">
          {/* -------------------------------------------------------------- */}
          <h3 className="tp-subtitle">
            Agreement between User and allthingsrams.com
          </h3>
          <p className="tp-content">
            Welcome to allthingsrams.com. The allthingsrams.com website (the
            &quot;Site&quot;) is comprised of various web pages operated by All
            Things Rams (&quot;ATR&quot;). allthingsrams.com is offered to you
            conditioned on your acceptance without modification of the terms,
            conditions, and notices contained herein (the &quot;Terms&quot;).
            Your use of allthingsrams.com constitutes your agreement to all such
            Terms. Please read these terms carefully, and keep a copy of them
            for your reference.
          </p>
          <p className="tp-content">
            allthingsrams.com is a News and Information Site, set up to bring
            up-to-date news on the LA Rams.
          </p>
          {/* -------------------------------------------------------------- */}
          <h3 className="tp-subtitle">Electronic Communications</h3>
          <p className="tp-content">
            Visiting allthingsrams.com or sending emails to ATR constitutes
          ...
          {/* -------------------------------------------------------------- */}
          <h3 className="tp-subtitle">Children Under Thirteen</h3>
          <p className="tp-content">
            ATR does not knowingly collect, either online or offline, personal
            information from persons under the age of thirteen. If you are under
            18, you may use allthingsrams.com only with permission of a parent
            or guardian.
          </p>
          {/* -------------------------------------------------------------- */}
          <h3 className="tp-subtitle">
          ...
          <p className="tp-content">
            allthingsrams.com contains links to other websites (&quot;Linked
            Sites&quot;). The Linked Sites are not under the control of ATR and
            ATR is not responsible for the contents of any Linked Site,
            including without limitation any link contained in a Linked Site, or
            any changes or updates to a Linked Site. ATR is providing these
            links to you only as a convenience, and the inclusion of any link
            does not imply endorsement by ATR of the site or any association
            with its operators.
          </p>
          <p className="tp-content">
            Certain services made available via allthingsrams.com are delivered
            by third party sites and organizations. By using any product,
            service or functionality originating from the allthingsrams.com
            domain, you hereby acknowledge and consent that ATR may share such
            information and data with any third party with whom ATR has a
            contractual relationship to provide the requested product, service
            or functionality on behalf of allthingsrams.com users and customers.
          </p>
          {/* -------------------------------------------------------------- */}
          <h3 className="tp-subtitle">
          ...
          <p className="tp-content">
            ...
            to access and use allthingsrams.com strictly in accordance with
            these terms of use. As a condition of your use of the Site, you
            warrant to ATR that you will not use the Site for any purpose that
          ...
          <p className="tp-content">
            ...
            used on the Site, is the property of ATR or its suppliers and
          ...
          <p className="tp-content">
            ...
            the Site. ATR content is not for resale. Your use of the Site does
            ...
            ATR and the copyright owner. You agree that you do not acquire any
            ownership rights in any protected content. We do not grant you any
            licenses, express or implied, to the intellectual property of ATR or
            our licensors except as expressly authorized by these Terms.
          </p>
          {/* -------------------------------------------------------------- */}
          <h3 className="tp-subtitle">Third Party Accounts</h3>
          <p className="tp-content">
            You will be able to connect your ATR account to third party
            accounts. By connecting your ATR account to your third party
          ...
          {/* -------------------------------------------------------------- */}
          <h3 className="tp-subtitle">International Users</h3>
          <p className="tp-content">
            The Service is controlled, operated and administered by ATR from our
            ...
            laws. You agree that you will not use the ATR Content accessed
            through allthingsrams.com in any country or in any manner prohibited
            by any applicable laws, restrictions or regulations.
          </p>
          {/* -------------------------------------------------------------- */}
          <h3 className="tp-subtitle">Indemnification</h3>
          <p className="tp-content">
            You agree to indemnify, defend and hold harmless ATR, its officers,
            ...
            rules or regulations. ATR reserves the right, at its own cost, to
            ...
            cooperate with ATR in asserting any available defenses.
          </p>
          {/* -------------------------------------------------------------- */}
          <h3 className="tp-subtitle">Arbitration</h3>
          <p className="tp-content">
          ...
          {/* -------------------------------------------------------------- */}
          <h3 className="tp-subtitle">Class Action Waiver</h3>
          <p className="tp-content">
          ...
          <p className="tp-content">
            ...
            ALL THINGS RAMS AND/OR ITS SUPPLIERS MAY MAKE IMPROVEMENTS AND/OR
            CHANGES IN THE SITE AT ANY TIME.
          </p>
          <p className="tp-content">
            ALL THINGS RAMS AND/OR ITS SUPPLIERS MAKE NO REPRESENTATIONS ABOUT
            ...
            IS&quot; WITHOUT WARRANTY OR CONDITION OF ANY KIND. ALL THINGS RAMS
          ...
          <p className="tp-content">
            ...
            ALL THINGS RAMS AND/OR ITS SUPPLIERS BE LIABLE FOR ANY DIRECT,
            ...
            ALL THINGS RAMS OR ANY OF ITS SUPPLIERS HAS BEEN ADVISED OF THE
          ...
          {/* -------------------------------------------------------------- */}
          <h3 className="tp-subtitle">Termination/Access Restriction</h3>
          <p className="tp-content">
            ATR reserves the right, in its sole discretion, to terminate your
            ...
            this agreement is governed by the laws of the State of Vermont and
            you hereby consent to the exclusive jurisdiction and venue of courts
            in Vermont in all disputes arising out of or relating to the use of
          ...
          <p className="tp-content">
            ...
            relationship exists between you and ATR as a result of this
            agreement or use of the Site. ATR&#39;s performance of this
            agreement is subject to existing laws and legal process, and nothing
            contained in this agreement is in derogation of ATR&#39;s right to
            ...
            provided to or gathered by ATR with respect to such use. If any part
          ...
          <p className="tp-content">
            ...
            entire agreement between the user and ATR with respect to the Site
            ...
            ATR with respect to the Site. A printed version of this agreement
          ...
          {/* -------------------------------------------------------------- */}
          <h3 className="tp-subtitle">Changes to Terms</h3>
          <p className="tp-content">
            ATR reserves the right, in its sole discretion, to change the Terms
            under which allthingsrams.com is offered. The most current version
            of the Terms will supersede all previous versions. ATR encourages
            you to periodically review the Terms to stay informed of our
            updates.
          </p>
          {/* -------------------------------------------------------------- */}
          <h3 className="tp-subtitle">Contact Us</h3>
          <p className="tp-content">
          ...
          <div className="terms-contact">
            <p className="tp-contact">Email Address:</p>
            <p className="tp-contact">allthingsrams.official@gmail.com</p>
          </div>
          <div className="terms-contact">
            <p className="tp-contact">Telephone number:</p>
